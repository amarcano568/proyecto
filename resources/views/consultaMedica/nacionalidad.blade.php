<select  data-placeholder="Nacionalidad..." id="nacionalidad" name="nacionalidad"  class="chosen-select form-control form-control-chosen" >
    <option value="" ></option>
    <optgroup id="country-optgroup-Americas" label="Latinoamérica">
    ...
    <optgroup id="country-optgroup-Americas" label="Resto de América">
        ...
        <option value="VI" label="Islas Vírgenes de los Estados Unidos">Islas Vírgenes de los Estados Unidos</option>
    ...
    <optgroup id="country-optgroup-Europa" label="Europa">
        ...
        <option value="IE" label="Irlanda">Irlanda</option>
        <option value="IM" label="Isla de Man">Isla de Man</option>
        <option value="IS" label="Islandia">Islandia</option>
        <option value="FO" label="Islas Feroe">Islas Feroe</option>
        <option value="AX" label="Islas Aland">Islas Aland</option>
        ...
        <option value="MC" label="Mónaco">Mónaco</option>
        ...
        <option value="CS" label="Serbia y Montenegro">Serbia y Montenegro</option>
        <option value="SE" label="Suecia">Suecia</option>
        <option value="CH" label="Suiza">Suiza</option>
        <option value="SJ" label="Svalbard y Jan Mayen">Svalbard y Jan Mayen</option>
        <option value="UA" label="Ucrania">Ucrania</option>
    </optgroup>
    <optgroup id="country-optgroup-Oceanía" label="Oceanía">
        ...
        <option value="CX" label="Isla Christmas">Isla Christmas</option>
        <option value="NU" label="Isla Niue">Isla Niue</option>
        <option value="NF" label="Isla Norfolk">Isla Norfolk</option>
        <option value="CC" label="Islas Cocos">Islas Cocos</option>
        ...
        <option value="SB" label="Islas Salomón">Islas Salomón</option>
        ...
        <option value="NC" label="Nueva Caledonia">Nueva Caledonia</option>
        ...
        <option value="IO" label="Territorio Británico del Océano Indico">Territorio Británico del Océano Indico</option>
    ...
    <optgroup id="country-optgroup-Asia" label="Asia">
        ...
        <option value="SA" label="Arabia Saudí">Arabia Saudí</option>
        ...
        <option value="CY" label="Chipre">Chipre</option>
        <option value="KP" label="Corea del Norte">Corea del Norte</option>
        <option value="KR" label="Corea del Sur">Corea del Sur</option>
        ...
        <option value="IR" label="Irán">Irán</option>
        ...
        <option value="KG" label="Kirguistán">Kirguistán</option>
        <option value="KW" label="Kuwait">Kuwait</option>
        <option value="LA" label="Laos">Laos</option>
        <option value="LB" label="Líbano">Líbano</option>
        <option value="MY" label="Malasia">Malasia</option>
        <option value="MV" label="Maldivas">Maldivas</option>
        ...
        <option value="HK" label="Región Administrativa Especial de Hong Kong de la República Popular China">Región Administrativa Especial de Hong Kong de la República Popular China</option>
        <option value="MO" label="Región Administrativa Especial de Macao de la República Popular China">Región Administrativa Especial de Macao de la República Popular China</option>
        <option value="SG" label="Singapur">Singapur</option>
        <option value="SY" label="Siria">Siria</option>
        <option value="LK" label="Sri Lanka">Sri Lanka</option>
        <option value="TH" label="Tailandia">Tailandia</option>
    ...
    <optgroup id="country-optgroup-África" label="África">
