...
// document.writeln("<script src='{{ asset('jsApp/odontCanvas/util/constants.js') }}");
// document.writeln("<script src='{{ asset('jsApp/odontCanvas/util/settings.js') }}");
// document.writeln("<script src='{{ asset('jsApp/odontCanvas/models/rect.js') }}");
// document.writeln("<script src='{{ asset('jsApp/odontCanvas/models/damage.js') }}");
// document.writeln("<script src='{{ asset('jsApp/odontCanvas/models/textBox.js') }}");
// document.writeln("<script src='{{ asset('jsApp/odontCanvas/models/tooth.js') }}");
// document.writeln("<script src='{{ asset('jsApp/odontCanvas/core/renderer.js') }}");
// document.writeln("<script src='{{ asset('jsApp/odontCanvas/core/odontogramaGenerator.js') }}");
// document.writeln("<script src='{{ asset('jsApp/odontCanvas/core/collisionHandler.js') }}");
